...
/**
 * @file lab.h
 * @brief Header file for a generic list data structure supporting multiple
 * implementations.
 */
 ...
 */
typedef enum { LIST_LINKED_SENTINEL } ListType;

/**
 * @typedef FreeFunc
 * @brief Function pointer type for freeing elements. If NULL, no action is
 * taken. Must be provided by the user when destroying the list or removing
 * elements.
 *
 */
